    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefono', models.CharField(blank=True, max_length=17, null=True, validators=[django.core.validators.RegexValidator(message='El teléfono debe tener formato: +999999999. Hasta 15 dígitos.', regex='^\\+?1?\\d{9,15}$')], verbose_name='Telefono')),
