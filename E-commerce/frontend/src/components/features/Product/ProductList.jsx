            ...
            >
                ...
                >
                    ...
                    <main className="min-h-screen md:min-h-[50vh]">
                        ...
                        {products.length === 0 ? (
                            <div className="flex flex-col items-center justify-start pt-10 w-full text-gray-500">
                                ...
                                <p className="text-center">
                                    ...
                                    <span className="text-xs font-normal italic">
                                        (Nuestra base de datos gratuita está despertando, gracias por tu paciencia)
                                    </span>
                                </p>
                            </div>
                        ) : (
